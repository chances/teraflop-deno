...
import { getStacktrace } from "./stacktrace.ts";
...
export interface IdGenerator {
  getNextId(object: any): number;
}

export class GPUObjectWrapper {
  onPreCall = new Signal();
  onPostCall = new Signal();
  onPromise = new Signal();
  onPromiseResolve = new Signal();
  recordStacktraces = false;
  private _skipRecord = 0;
  ...
  _wrapGPUTypes() {
    ...
    GPU.prototype.getPreferredCanvasFormat = this._wrapMethod("getPreferredCanvasFormat", GPU.prototype.getPreferredCanvasFormat);
    ...
    // TODO: GPUCanvasContext.prototype.configure = this._wrapMethod("configure", GPUCanvasContext.prototype.configure);
    // TODO: GPUCanvasContext.prototype.unconfigure = this._wrapMethod("unconfigure", GPUCanvasContext.prototype.unconfigure);
    // TODO: GPUCanvasContext.prototype.getCurrentTexture = this._wrapMethod("getCurrentTexture", GPUCanvasContext.prototype.getCurrentTexture);
  ...
  _wrapMethod(method: string, origMethod: Function) {
    const self = this;
